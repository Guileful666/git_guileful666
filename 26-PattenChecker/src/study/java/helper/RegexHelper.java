...
public class RegexHelper {
	 ...
	 * 숫자 모양에 대한 검사
	 * @parm str- 검사할 문자역
	 * @return boolean - 형식에 맞을 경우 ture, 아닌 경우 false
	 */
	...
	/**
	 * 영문만으로 구성되어있는지에 대한 형식 검사
	 * @parm str- 검사할 문자열
	 * @retuen  boolean - 형식 맞으면 true, 아니면 false
	 */
	 ...
	 * @parm str - 검사할 문자열
	 * @return boolean - 형식 맞으면 true, 아니면 false
	 */
